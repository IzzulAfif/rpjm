...
|---------------------------------
*/
class M_bidangurusanpenunjang extends CI_Model{
    ...
    public function saveBidangUrusanPenunjang($kode_urusan, $kode_bidangrpjm, $nama_bidangrpjm, $no_bidangrpjm){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function updateBidangUrusanPenunjang($kode_urusan, $kode_bidangrpjm, $nama_bidangrpjm, $no_bidangrpjm){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function deleteBidangUrusanPenunjang($kode_bidangrpjm){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        $db->where('kode_bidangrpjm',$kode_bidangrpjm);
    ...
    public function searchBidangUrusanPenunjang($name, $kode_urusan){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function cekBidangUrusanPenunjangDetail($kode_urusan){
        $this->setConnection('dbsystem');
        $db = $this->getConnection();
    ...
    public function getBidangUrusanPenunjangDetail($kode_urusan){
        $this->setConnection('dbsystem');
        $db = $this->getConnection();
