...
|---------------------------------
*/
class M_usulankomunitas extends CI_Model{
	...
	public function getGridUsulanKomunitas($limit, $offset){
        ...
        $db->where('m.kode_jenisusulan','JU006');
	...
	public function countGridUsulanKomunitas(){
		$this->setConnection('dbsystem');
		$db = $this->getConnection();
    ...
    public function saveUsulanKomunitas($kode_musrenbang, $tahun, $kode_jenisusulan, $created, $createdby, $kegiatan, $lokasi, $volume, $kode_satuan, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function updateUsulanKomunitas($kode_musrenbang, $updated, $updatedby, $kegiatan, $lokasi, $volume, $kode_satuan, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function deleteUsulanKomunitas($kode_musrenbang){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        $db->where('kode_musrenbang',$kode_musrenbang);
    ...
    public function searchUsulanKomunitas($name){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
