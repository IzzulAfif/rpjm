...
|---------------------------------
*/
class M_usulanakademisi extends CI_Model{
	...
	public function getGridUsulanAkademisi($limit, $offset){
        ...
        $db->where('m.kode_jenisusulan','JU005');
	...
	public function countGridUsulanAkademisi(){
		$this->setConnection('dbsystem');
		$db = $this->getConnection();
    ...
    public function saveUsulanAkademisi($kode_musrenbang, $tahun, $kode_jenisusulan, $created, $createdby, $kegiatan, $lokasi, $volume, $kode_satuan, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function updateUsulanAkademisi($kode_musrenbang, $updated, $updatedby, $kegiatan, $lokasi, $volume, $kode_satuan, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function deleteUsulanAkademisi($kode_musrenbang){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        $db->where('kode_musrenbang',$kode_musrenbang);
    ...
    public function searchUsulanAkademisi($name){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
