...
|---------------------------------
*/
class M_usulanduniausaha extends CI_Model{
	...
	public function getGridUsulanDuniausaha($limit, $offset){
        ...
        $db->where('m.kode_jenisusulan','JU007');
	...
	public function countGridUsulanDuniausaha(){
		$this->setConnection('dbsystem');
		$db = $this->getConnection();
    ...
    public function saveUsulanDuniausaha($kode_musrenbang, $tahun, $kode_jenisusulan, $created, $createdby, $kegiatan, $lokasi, $volume, $kode_satuan, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function updateUsulanDuniausaha($kode_musrenbang, $updated, $updatedby, $kegiatan, $lokasi, $volume, $kode_satuan, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function deleteUsulanDuniausaha($kode_musrenbang){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        $db->where('kode_musrenbang',$kode_musrenbang);
    ...
    public function searchUsulanDuniausaha($name){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
