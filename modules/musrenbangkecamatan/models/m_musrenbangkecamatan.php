...
|---------------------------------
*/
class M_musrenbangkecamatan extends CI_Model{
	...
	public function getGridMusrenbangKecamatan($limit, $offset){
	...
	public function countGridMusrenbangKecamatan(){
		$this->setConnection('dbsystem');
		$db = $this->getConnection();
    ...
    public function saveMusrenbangKecamatan($kode_musrenbang, $tahun, $kode_jenisusulan, $created, $createdby, $kode_unitkerja, $kode_lingkupbidang, $kegiatan, $lokasi, $volume, $kode_satuan, $kode_prioritas, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude, $catatan_kecamatan){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        ...
        $db->set('prioritas_kecamatan', $kode_prioritas);
        ...
        $db->set('catatan_kecamatan', $catatan_kecamatan);
        $db->insert('trs_musrenbang');
    }

    public function updateMusrenbangKecamatan($kode_musrenbang, $updated, $updatedby, $kode_lingkupbidang, $kegiatan, $lokasi, $volume, $kode_satuan, $kode_prioritas, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude, $catatan_kecamatan){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        ...
        $data = array(
            ...
            'prioritas_kecamatan'   => $kode_prioritas,
            'swadana'               => $swadana,
            'apbd_kab'              => $apbd_kab,
            'apbd_prov'             => $apbd_prov,
            'apbn'                  => $apbn,
    ...
    public function deleteMusrenbangKecamatan($kode_musrenbang){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        $db->where('kode_musrenbang',$kode_musrenbang);
    ...
    public function searchMusrenbangKecamatan($name){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
