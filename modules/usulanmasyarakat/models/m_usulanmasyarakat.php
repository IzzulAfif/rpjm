...
|---------------------------------
*/
class M_usulanmasyarakat extends CI_Model{
	...
	public function getGridUsulanMasyarakat($limit, $offset){
        ...
        $db->where('m.kode_jenisusulan','JU008');
	...
	public function countGridUsulanMasyarakat(){
		$this->setConnection('dbsystem');
		$db = $this->getConnection();
    ...
    public function saveUsulanMasyarakat($kode_musrenbang, $tahun, $kode_jenisusulan, $created, $createdby, $kegiatan, $lokasi, $volume, $kode_satuan, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function updateUsulanMasyarakat($kode_musrenbang, $updated, $updatedby, $kegiatan, $lokasi, $volume, $kode_satuan, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function deleteUsulanMasyarakat($kode_musrenbang){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        $db->where('kode_musrenbang',$kode_musrenbang);
    ...
    public function searchUsulanMasyarakat($name){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
