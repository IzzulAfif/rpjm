...
|---------------------------------
*/
class M_musrenbangdesa extends CI_Model{
	...
	public function getGridMusrenbangDesa($limit, $offset){
        ...
        $db->where('m.kode_jenisusulan','JU001');
	...
	public function countGridMusrenbangDesa(){
		$this->setConnection('dbsystem');
		$db = $this->getConnection();
    ...
    public function saveMusrenbangDesa($kode_musrenbang, $tahun, $kode_jenisusulan, $created, $createdby, $kode_bidangdesa, $kegiatan, $lokasi, $volume, $kode_satuan, $kode_prioritas, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude, $catatan_deskel){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function updateMusrenbangDesa($kode_musrenbang, $updated, $updatedby, $kode_bidangdesa, $kegiatan, $lokasi, $volume, $kode_satuan, $kode_prioritas, $swadana, $apbd_kab, $apbd_prov, $apbn, $latitude, $longitude, $catatan_deskel){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
    ...
    public function deleteMusrenbangDesa($kode_musrenbang){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
        $db->where('kode_musrenbang',$kode_musrenbang);
    ...
    public function searchMusrenbangDesa($name){
    	$this->setConnection('dbsystem');
        $db   = $this->getConnection();
