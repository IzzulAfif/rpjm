Ext.define('RPJM.controller.Dashboard',{
	extend	: 'Ext.app.Controller',
    init: function() {
        var me = this;
        me.getStore('RPJM.store.TreeStore');
        me.control({
    ...
    logoutUser : function(button){
        window.location = BASE_URL + 'homepages/logout'
    },
    rubahPswd : function(button){
        var win = Ext.create('RPJM.module.GeneralSetup.Account.view.form.EditPswd');
        win.show();
    }, 
    rubah : function(btn){
        var me          = this;
