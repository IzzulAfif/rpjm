Ext.define('RPJM.module.Renja.TransaksiRenja.view.form.FormRenjaKelurahan', {
    extend      : 'Ext.form.Panel',
    title       : 'Form Usulan Kelurahan',
    alias       : 'widget.formrenjakelurahan',
    id          : 'formrenjakelurahan',
    layout      : 'fit',
    border      : true,
    frame       : true,
    margins     : '3px',
                        ...
                        items   : [
                            {
                                ...
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupKegiatanKelurahan'),
                                anchor          : '100%',
                        ...
                        items   : [
                            {
                                ...
                                allowBlank      : true,
                                emptyText       : 'Usulan Kelurahan',
                                labelAlign      : 'top',
                                labelStyle      : 'padding : 3px; font-weight : bold;',
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupUsulanKelurahan'),
                                anchor          : '100%',
                                padding         : '0px 2px 0px 2px',
                            ...
                            {
                                xtype           : 'button',
                                fieldLabel      : 'Usulan Kelurahan',
                                text            : 'Load Data',
                                iconCls         : 'icon-lookup',
                                action          : 'loadUsulanKelurahan',
                                flex            : 0.3
                            }
                        ]
                    },
        ...
        me.buttons = [
            {
                text    : 'Save',
                iconCls : 'icon-save',
                action  : 'saveRenjaKelurahan'
            },
            {
                text    : 'Reset',
                iconCls : 'icon-refresh',
                action  : 'resetRenjaKelurahan'
            }
        ];
