Ext.define('RPJM.module.Renja.TransaksiRenja.view.form.FormRenjaSkpd', {
    extend      : 'Ext.form.Panel',
    title       : 'Form Usulan SKPD',
    alias       : 'widget.formrenjaskpd',
    id          : 'formrenjaskpd',
    layout      : 'fit',
    border      : true,
    frame       : true,
                        ...
                        items   : [
                            {
                                ...
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupKegiatanSkpd'),
                                anchor          : '100%',
                        ...
                        items   : [
                            {
                                ...
                                allowBlank      : true,
                                emptyText       : 'Usulan SKPD',
                                labelAlign      : 'top',
                                labelStyle      : 'padding : 3px; font-weight : bold;',
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupUsulanSkpd'),
                                anchor          : '100%',
                                padding         : '0px 2px 0px 2px',
                            ...
                            {
                                xtype           : 'button',
                                fieldLabel      : 'Usulan SKPD',
                                text            : 'Load Data',
                                iconCls         : 'icon-lookup',
                                action          : 'loadUsulanSkpd',
                                flex            : 0.3
                            }
                        ]
                    },
