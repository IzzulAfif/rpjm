Ext.define('RPJM.module.Renja.TransaksiRenja.view.form.FormRenjaDesa', {
    extend      : 'Ext.form.Panel',
    title       : 'Form Usulan Desa',
    alias       : 'widget.formrenjadesa',
    id          : 'formrenjadesa',
    layout      : 'fit',
    border      : true,
    frame       : true,
                        ...
                        items   : [
                            {
                                ...
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupKegiatanDesa'),
                                anchor          : '100%',
                        ...
                        items   : [
                            {
                                ...
                                allowBlank      : true,
                                emptyText       : 'Usulan Desa',
                                labelAlign      : 'top',
                                labelStyle      : 'padding : 3px; font-weight : bold;',
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupUsulanDesa'),
                                anchor          : '100%',
                                padding         : '0px 2px 0px 2px',
                            ...
                            {
                                xtype           : 'button',
                                fieldLabel      : 'Usulan Desa',
                                text            : 'Load Data',
                                iconCls         : 'icon-lookup',
                                action          : 'loadUsulanDesa',
                                flex            : 0.3
                            }
                        ]
                    },
        ...
        me.buttons = [
            {
                text    : 'Save',
                iconCls : 'icon-save',
                action  : 'saveRenjaDesa'
            },
            {
                text    : 'Reset',
                iconCls : 'icon-refresh',
                action  : 'resetRenjaDesa'
            }
        ];
