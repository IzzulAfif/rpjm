Ext.define('RPJM.module.Renja.TransaksiRenja.view.form.FormRenjaKecamatan', {
    extend      : 'Ext.form.Panel',
    title       : 'Form Usulan Kecamatan',
    alias       : 'widget.formrenjakecamatan',
    id          : 'formrenjakecamatan',
    //layout      : 'fit',
    border      : true,
    frame       : true,
    height      : 800,
                        ...
                        items   : [
                            {
                                ...
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupKegiatanKecamatan'),
                                anchor          : '100%',
                        ...
                        items   : [
                            {
                                ...
                                allowBlank      : true,
                                emptyText       : 'Usulan Kecamatan',
                                labelAlign      : 'top',
                                labelStyle      : 'padding : 3px; font-weight : bold;',
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupUsulanKecamatan'),
                                anchor          : '100%',
                                padding         : '0px 2px 0px 2px',
                            ...
                            {
                                xtype           : 'button',
                                fieldLabel      : 'Usulan Kecamatan',
                                text            : 'Load Data',
                                iconCls         : 'icon-lookup',
                                action          : 'loadUsulanKecamatan',
                                flex            : 0.3
                            }
                        ]
                    },
        ...
        me.buttons = [
            {
                text    : 'Save',
                iconCls : 'icon-save',
                action  : 'saveRenjaKecamatan'
            },
            {
                text    : 'Reset',
                iconCls : 'icon-refresh',
                action  : 'resetRenjaKecamatan'
            }
        ];
