Ext.define('RPJM.module.Renja.TransaksiRenja.view.form.FormRenjaMasyarakat', {
    extend      : 'Ext.form.Panel',
    title       : 'Form Usulan Masyarakat',
    alias       : 'widget.formrenjamasyarakat',
    id          : 'formrenjamasyarakat',
    layout      : 'fit',
    border      : true,
    frame       : true,
    margins     : '3px',
                        ...
                        items   : [
                            {
                                ...
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupKegiatanMasyarakat'),
                                anchor          : '100%',
                        ...
                        items   : [
                            {
                                ...
                                allowBlank      : true,
                                emptyText       : 'Usulan Masyarakat',
                                labelAlign      : 'top',
                                labelStyle      : 'padding : 3px; font-weight : bold;',
                                store           : Ext.create('RPJM.module.Renja.TransaksiRenja.store.LookupUsulanMasyarakat'),
                                anchor          : '100%',
                                padding         : '0px 2px 0px 2px',
                            ...
                            {
                                xtype           : 'button',
                                fieldLabel      : 'Usulan Masyarakat',
                                text            : 'Load Data',
                                iconCls         : 'icon-lookup',
                                action          : 'loadUsulanMasyarakat',
                                flex            : 0.3
                            }
                        ]
                    },
        ...
        me.buttons = [
            {
                text    : 'Save',
                iconCls : 'icon-save',
                action  : 'saveRenjaMasyarakat'
            },
            {
                text    : 'Reset',
                iconCls : 'icon-refresh',
                action  : 'resetRenjaMasyarakat'
            }
        ];
