Ext.define('RPJM.module.GeneralSetup.Role.controller.Role', {
    extend  : 'Ext.app.Controller',
    CheckedDataEdit: [],

    init: function() {
        var me = this;
        me.getStore('RPJM.module.GeneralSetup.Role.store.Role').load();
        me.getStore('RPJM.module.GeneralSetup.Role.store.RoleMenu').load();
        me.control({
    ...
    reloadStore: function(){
        var me = this;
        me.getStore('RPJM.module.GeneralSetup.Role.store.Role').reload();
    },
    ...
    viewRole: function(grid, record, item, index, e, eOpts){
        ...
        Ext.Ajax.request({
            ...
            success         : function(response){
                ...
                var storeMenu = Ext.getStore('RPJM.module.GeneralSetup.Role.store.RoleMenu');
                    ...
                    Ext.Ajax.request({
                        ...
                        success         : function(response){
                            ...
                            if(data.msg === 1){
                                ...
                                var storeApproval = Ext.getStore('RPJM.module.GeneralSetup.Role.store.Role');
    ...
    reset: function(btn) {//Reset Form
        ...
        me.getStore('RPJM.module.GeneralSetup.Role.store.Role').reload();
        me.getStore('RPJM.module.GeneralSetup.Role.store.RoleMenu').reload();
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 1){
                    ...
                    scope.reset();
                    me.getStore('RPJM.module.GeneralSetup.Role.store.Role').removeAll();
                    me.getStore('RPJM.module.GeneralSetup.Role.store.Role').reload();
    ...
    addRole: function(grid, record, item, index, e, eOpts){
        ...
        if(record.data.id_role === '' || record.data.id_role === null)
        {
            ...
            this.getStore('RPJM.module.GeneralSetup.Role.store.ViewAllMenu').reload(); 
            this.getStore('RPJM.module.GeneralSetup.Role.store.ViewAllMenu').removeAll();      
            var win = Ext.create('RPJM.module.GeneralSetup.Role.view.form.FormRoleMenu');
            win.show();
