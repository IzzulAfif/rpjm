Ext.define('RPJM.module.GeneralSetup.Role.view.grid.GridRoleMenu', {
    extend   : 'Ext.grid.Panel',
    store    : 'RPJM.module.GeneralSetup.Role.store.RoleMenu',
                            ...
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    ...
                                    success         : function(response){
                                        ...
                                        var storeModul = Ext.getStore('RPJM.module.GeneralSetup.Role.store.RoleMenu');
