Ext.define('RPJM.module.GeneralSetup.Role.view.form.FormRoleMenu', {
    extend      : 'Ext.window.Window',
    closeable   : true,
    modal       : true,
    requires    : ['RPJM.module.GeneralSetup.Role.store.ViewAllMenu'],
        ...
        me.items  = [
            {
                ...
                items       : [
                    ...
                    },
                    {
                        ...
                        fieldLabel  : 'Menu',
                        autoScroll  : false,
                        store       : Ext.create('RPJM.module.GeneralSetup.Role.store.ViewAllMenu'),
