Ext.define('RPJM.module.GeneralSetup.Menu.controller.Menu', {
    extend  : 'Ext.app.Controller',
    CheckedDataEdit: [],

    init: function() {
        var me = this;
        me.getStore('RPJM.module.GeneralSetup.Menu.store.Menu').load();
        me.control({
    ...
    reloadStore: function(){
        var me = this;
        me.getStore('RPJM.module.GeneralSetup.Menu.store.Menu').reload();
    },
                    ...
                    Ext.Ajax.request({
                        ...
                        success         : function(response){
                            ...
                            if(data.msg === 1){
                                ...
                                var storeApproval = Ext.getStore('RPJM.module.GeneralSetup.Menu.store.Menu');
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 1){
                    ...
                    Ext.getCmp('formmenu').getForm().reset();
                    me.getStore('RPJM.module.GeneralSetup.Menu.store.Menu').removeAll();
                    me.getStore('RPJM.module.GeneralSetup.Menu.store.Menu').reload();
    ...
    update: function(btn, evt, opts){
        var me          = this;
        var form        = btn.up('form').getForm();
        var id_seq      = form.findField('id_seq').getValue();
        var id          = form.findField('id').getValue();
        var name        = form.findField('name').getValue();
        var parent      = form.findField('parent').getValue();
        var icon        = form.findField('icon').getValue();
