Ext.define('RPJM.module.Musrenbang.MusrenbangKecamatan.view.form.FormMusrenbangKecamatan', {
    extend      : 'Ext.form.Panel',
    title       : 'Form MusrenbangKecamatan',
    ...
    alias       : 'widget.formmusrenbangkecamatan',
    id          : 'formmusrenbangkecamatan',
    layout      : 'fit',
    border      : true,
    frame       : true,
    margins     : '3px',
        ...
        me.buttons = [
            {
                ...
                iconCls : 'icon-save',
                action  : 'save',
                disabled: createMusrenbangKecamatan
            },
            {
                text    : 'Edit',
                iconCls : 'icon-edit',
                action  : 'update',
                disabled: updateMusrenbangKecamatan
            },
            {
                text    : 'Reset',
