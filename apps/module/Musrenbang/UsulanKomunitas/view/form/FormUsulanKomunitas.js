Ext.define('RPJM.module.Musrenbang.UsulanKomunitas.view.form.FormUsulanKomunitas', {
    extend      : 'Ext.form.Panel',
    title       : 'Form UsulanKomunitas',
    ...
    alias       : 'widget.formusulankomunitas',
    id          : 'formusulankomunitas',
    layout      : 'fit',
    border      : true,
    frame       : true,
    margins     : '3px',
        ...
        me.buttons = [
            {
                ...
                iconCls : 'icon-save',
                action  : 'save',
                disabled: createUsulanKomunitas
            },
            {
                text    : 'Edit',
                iconCls : 'icon-edit',
                action  : 'update',
                disabled: updateUsulanKomunitas
            },
            {
                text    : 'Reset',
